...
/*
	This resource uses the global variable "p_processheap".

	Make sure "p_processheap" is properly initialized by calling "p_processheap = GetProcessHeap();" prior to calling "MyGL::initialize()".
*/
